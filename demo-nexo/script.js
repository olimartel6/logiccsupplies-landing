/* Nexo — Traitements parasitaires — interactions */
...
(function () {
  ...
  (function () {
    ...
    if (openSeason) {
      ...
      label.textContent = 'Saison estivale ouverte — On protège votre maison';
    } else {
      status.classList.add('closed');
      label.textContent = 'Réservez dès maintenant votre traitement du printemps';
    }
  })();
  ...
  (function () {
    ...
    var vehicleLabels = {
      ...
      araignees: 'Araignées',
      guepes: 'Guêpes',
      coccinelles: 'Coccinelles / autres'
    };
    ...
    function recompute() {
      ...
      if (bookLink) {
        // No online booking — the CTA calls Étienne directly.
        bookLink.setAttribute('href', 'tel:+15819859475');
      }
    }
