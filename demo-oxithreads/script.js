...
(function () {
  ...
  if (!prefersReducedMotion && window.matchMedia('(hover: hover)').matches && window.innerWidth >= 980) {
    ...
    loop();
    document.querySelectorAll('a, button, .svc, .m-item, .r-card').forEach(function (el) {
  ...
  if (!prefersReducedMotion && window.matchMedia('(hover: hover)').matches) {
    document.querySelectorAll('.btn, .nav-cta').forEach(function (btn) {
      ...
      btn.addEventListener('mousemove', function (e) {
        ...
        var dx = (e.clientX - bcx) * 0.25;
        var dy = (e.clientY - bcy) * 0.3;
  ...
  /* ----------------------------------------------------------------
     Marquee strip — duplicate content for seamless loop
  ---------------------------------------------------------------- */
